...
bot = telebot.TeleBot('5018849548:AAGu-gRtNvJ9YLQI8qLadXj3zLGKYcF1KF8')

conn = psycopg2.connect(database="pyatlab", user="postgres", password="151081cxz", host="localhost", port="5432")
cursor = conn.cursor()
